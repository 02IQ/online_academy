            ...
            <div class="nav">
                ...
                @if (Auth::check())
                    <form id="logout-form" action="{{ route('logout') }}" method="POST">
                        ...
                        <a href="#"onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn_nav">Выйти</a>
                        </div>
                    </form>
    ...
    <footer>
        <div class="blockfoot">
            <div class="columnfoot1">
                ...
                <div class="textfoot">Свяжитесь с нами для получения дополнительной информации о курсах и возможностях
                    обучения. Мы всегда рады помочь!</div>
                <div class="socseti"><img src="{{asset('images/social.svg')}}" alt=""></div>
            </div>
            <div class="columnfoot2">
                <div class="contact">Контакты</div>
                <div class="info_contact"><span class="img_foot"><img src="{{asset('images/phone.svg')}}" alt=""></span>
                    Phone : 8 800 555335</div>
                <div class="info_contact"><span class="img_foot"><img src="{{asset('images/email.svg')}}" alt=""></span>
                    Email : contact@info.com</div>
                <div class="info_contact"><span class="img_foot"><img src="{{asset('images/addres.svg')}}"
                            alt=""></span> Address : Россия, Ульяновск</div>
            </div>
        </div>
        <div class="copyright">Copyright 2024 Онлайн-Академия. Design By <span class="copyr">Онлайн-Акадмемия</span>
        </div>
    </footer>
</body>
